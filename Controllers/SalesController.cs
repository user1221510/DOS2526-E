...
namespace ProductsAPI.Controllers
{
    ...
    {
        private static readonly User MockUser = new User { Id = 1, Username = "joaos", Email = "joao@example.com", FullName = "Jo�o Silva", Role = "Admin" };
        ...
        public IActionResult Update(int id, Sale updatedSale)
        {
            ...
            // Atualiza as propriedades de rela��o
